...
// [p.321] 객체 이동[!!!! : document(메모리-객체 1개)]
document.addEventListener('DOMContentLoaded', function(){
    ...
    setTimeout(function(){
        ...
        console.log(h2.parentNode);     // 객체명.partentNode : 해당 객체의 부모 호출 => body
    ...
    h3.addEventListener('click', function(event){
        // 1. click 이벤트가 발생할 때 실행되는 함수. addEventListener
        // 2. 그 이벤트를 발생한 *결과내용(객체)을 콜백함수의 매개변수로 전달
